...
public class RequestFream extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.request_fream, container, false);
...
*/
        ...
        MuserDatabase = FirebaseDatabase.getInstance().getReference().child("Request_post");
